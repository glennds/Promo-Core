    ...
    <table class="shop_table shop_table_responsive cart woocommerce-cart-form__contents" cellspacing="0">
        <thead>
            <tr>
                ...
                <th class="product-price"><?php echo esc_html( ds_paynow_column_get_pay_now_label() ); ?></th>
        ...
        <tbody>
            ...
            foreach ( WC()->cart->get_cart() as $cart_item_key => $cart_item ) {
                ...
                <tr class="woocommerce-cart-form__cart-item <?php echo esc_attr( apply_filters( 'woocommerce_cart_item_class', 'cart_item', $cart_item, $cart_item_key ) ); ?>">
                    ...
                    <td class="product-regular-price" data-title="<?php echo esc_attr( ds_paynow_column_get_regular_price_label() ); ?>">
                        <?php echo wp_kses_post( ds_paynow_column_get_cart_regular_price_html( $cart_item ) ); ?>
                    </td>
                    <td class="product-price" data-title="<?php echo esc_attr( ds_paynow_column_get_pay_now_label() ); ?>">
